...
from heremaps_data_downloader import file_exist
import pickle

EDGE_LIST_PATH = '../Cache/EDGE_LIST.pkl'
NODE_LIST_PATH = '../Cache/NODE_LIST.pkl'
current_MAX=0
...
def get_annotated_Graph(G):
    ...
    NODE_LIST=None
    EDGE_LIST=None
    if file_exist(EDGE_LIST_PATH):
        EDGE_LIST = load_file(EDGE_LIST_PATH)
        NODE_LIST = load_file(NODE_LIST_PATH)
        ...
        #print(NODE_LIST)
        save_file(NODE_LIST,NODE_LIST_PATH)
        save_file(EDGE_LIST,EDGE_LIST_PATH)
